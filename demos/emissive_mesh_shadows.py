"""Isolated emissive panel and blocker for local shadow inspection."""
import genesis as gx

gx.window.configure(title="Genesis - Emissive Mesh Shadows", width=1280, height=720, vsync=False)
...
gx.scene.load("assets/lighting/emissive-occlusion-stage.gltf")
